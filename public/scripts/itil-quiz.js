...
let questionsList = shuffle([...questions]);
let current = 0;
...
function showResults() {
  ...
  app.innerHTML = `
    <div class="py-12 text-center">
      ...
      <button class="mt-2 px-7 py-3 bg-gold text-dark font-bold rounded-full shadow hover:opacity-90 transition" onclick="restartQuiz()">
        Quiz neu starten
      </button>
    </div>
  `;
...
window.restartQuiz = () => {
  questionsList = shuffle([...questions]);
  current = 0;
